...
export default {
  ...
  methods: {
    ...
    animeImg(value) {
      ...
      gsap
        ...
        .add(()=>this.changeImg(value))
          .set([wrapper_img_center.querySelector('a img'), wrapper_img_right.querySelector('a img'), wrapper_img_left.querySelector('a img')],{
           top:'-100%'
          }).to([wrapper_img_left.querySelector('a img'),wrapper_img_right.querySelector('a img'),wrapper_img_center.querySelector('a img') ], {
          duration:duration,
          stagger: 0.01,
          top: '50%',
          ease:'expo.inOut'
        ...
        },'finish').to(wrapper_img_right,{
           rotate:'12deg',
          x:'-20%', 
         
        },'finish').to(wrapper_img_left,{
           rotate:'-12deg',
           x:'-80%',
    ...
    animeTitle(){
      const duration=1;
      gsap.timeline().to('.title--component span',{
        duration:duration,
        stagger:0.02,
        skewX:'-40deg',
        skewY:'-40deg',
